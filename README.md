...
- **Property pages** with photo galleries, availability calendars, rental conditions, floor plans, live travel times to city landmarks, and an interactive location map.
...
| `property.html` | Property detail: gallery, availability calendar, conditions, floor plans, travel times, location map, booking-request CTA |
