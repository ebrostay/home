...
export function Wordmark() {
  return (
    <span className="group flex items-center gap-2">
      ...
      {/* The word costs 81px. Against the icon-only pill it stays down to
          368px — where the bar still has 21px to spare — and drops below that
          so the mark alone carries the brand on a 320px phone rather than the
          row overflowing. */}
      <span className="hidden font-display text-xl font-semibold tracking-tight text-ink min-[23rem]:inline">
